...
blog.constant('blogConfig',{
    "site_name":"Schumilin's Blog",
    "pagesize":10, //每页显示文章数
    "duoshuo_domain":"schumilin",//多说评论，你在多说上申请的二级域名
    "categories":["PHP","ThinkPHP","服务器","数据库","前端","HTML5","CSS","javascript","jQuery","bootstrap","angularjs","phonegap","go","python","工具","编辑器"],
    "AVOS_ID":"19y6o5esy7ittz5z3bhx4bddn0ad5e7mk1bpqfn4lokwspul",
    "AVOS_KEY":"aryb0p2rlcjlizu85hos2lzm4exhoofzdmvs0ix30k2tan90",
    "header_pics":[
